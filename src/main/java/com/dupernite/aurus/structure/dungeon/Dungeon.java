package com.dupernite.aurus.structure.dungeon;
...
public class Dungeon extends Structure {
    ...
    public static final Codec<Dungeon> CODEC = RecordCodecBuilder.<Dungeon>mapCodec(instance ->
            instance.group(Dungeon.configCodecBuilder(instance),
            ...
            ).apply(instance, Dungeon::new)).codec();
    ...
    public Dungeon(Structure.Config config,
    ...
    public Optional<Structure.StructurePosition> getStructurePosition(Structure.Context context) {
        ...
        if (!Dungeon.extraSpawningChecks(context)) {
    ...
    public StructureType<?> getType() {
        return ModStructures.DUNGEON; // Helps the game know how to turn this structure back to json to save to chunks
    }
}