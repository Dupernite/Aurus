...
public class AurusREIClientPlugin implements REIClientPlugin {
    @Override
    public void registerCategories(CategoryRegistry registry) {
        registry.add(new UpgraderCategory());
        registry.addWorkstations(UpgraderCategory.UPGRADER_DISPLAY, EntryStacks.of(ModBlock.UPGRADER));
    }
    ...
    public void registerScreens(ScreenRegistry registry) {
        registry.registerClickArea(screen -> new Rectangle(((screen.width - 176) / 2) + 78,
                ...
                UpgraderScreen.class, UpgraderCategory.UPGRADER_DISPLAY);
    }
}
